...
let argv = require('yargs')
    ...
    .boolean('valid')
    .describe('valid', 'try to ensure inverse output is valid - deprecated in favor of --keepReferences')
    .boolean('keepReferences')
    .describe('keepReferences', 'works with --inverse to ensure required and transitive references are kept when filtering declarations')
    .boolean('strip')
    .alias('strip','s')
